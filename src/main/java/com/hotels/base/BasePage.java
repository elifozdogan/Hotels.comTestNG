...
public class BasePage {
	...
	public WebDriver initialize_driver(Properties prop){
	 ...
	 flash = prop.getProperty("elementflash");
      ...
      if(browser.equalsIgnoreCase("chrome")){
    	  ...
    	  System.setProperty("webdriver.chrome.driver", "/Users/elifozdogan/Downloads/chromedriver");
	...
	public Properties initialize_properties(){
	 ...
	 try{
	 FileInputStream ip = new FileInputStream("/Users/elifozdogan/Documents/workspace/TestNGFrameworkHotels.com2019/src/main/java/config/hotels/config/config.properties");
	    prop.load(ip);
